...
class SideNavDrawer {
            ...
            <div class="drawer-content">
                ...
                <div class="drawer-section">
                    ...
                    <div class="drawer-utilities-grid">
                        ...
                        <button id="drawer-presets-btn" class="utility-btn" title="Matrix Presets">
                            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    setupEventListeners() {
        ...
        document.getElementById("drawer-presets-btn").addEventListener("click", () => {
            if (window.innerWidth < 768) {
                this.close();
            }
            if (window.presetsDrawer) {
                window.presetsDrawer.toggle();
            }
        });
