...
| **All** | **265** | **56** | **182** | **8** | **19** | **0** | **0** | **261** | **32** |
...
- Features with fresh passing scenario evidence: **7** of 265.
- Features with a fresh failing scenario: **0**.
- Features capped at V1 by an open critical/high finding: **95**.
...
| F-MTX-007 | Mute / unmute the audio of an output | V4 | V1 (capped) | V1 | stale | [outputs.audio_mute·api·pass](evidence/F-MTX-007/2026-09-25-V2-22afc1a7-outputs.audio_mute-api.json)<br>[outputs.audio_mute·api·pass](evidence/F-MTX-007/2026-09-25-V2-d6668000-outputs.audio_mute-api.json) | BE-12(M), HIL-09(C) |
...
| F-MTX-010 | Set an output's HDR mode | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-011 | Set an output's scaler mode (incl. audio-only) | V4 | V1 (capped) | V1 | — | — | BE-12(M), BE-15(M), HIL-09(C) |
| F-MTX-012 | Enable / disable ARC on an output | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-013 | Set an input's EDID | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-014 | Copy EDID from a connected display | V4 | V1 (capped) | V1 | — | — | BE-25(L), HIL-09(C) |
| F-MTX-015 | External audio: matrix mode | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-016 | External audio: enable per output | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-017 | External audio: source per output | V4 | V1 (capped) | V1 | — | — | BE-12(M), HIL-09(C) |
| F-MTX-018 | Front-panel beep on / off | V4 | V1 | V1 | — | — | BE-12(M) |
| F-MTX-019 | Front-panel lock | V4 | V1 | V1 | — | — | BE-12(M) |
| F-MTX-020 | Front-panel LCD timeout | V4 | V1 (capped) | V1 | — | — | API-07(M), BE-12(M), HIL-09(C) |
...
| F-MTX-026 | Show which cables are plugged in (Telnet link status) | V4 | V1 (capped) | V1 | — | — | BE-03(H), BE-29(H), BE-30(L), HIL-03(M) |
...
| F-DOM-004 | Recall a profile: its power-on / power-off macro runs | V4 | V1 (capped) | V1 | stale | [profiles.recall_power_macro·api·fail](evidence/F-DOM-004/2026-09-25-V2-22afc1a7-profiles.recall_power_macro-api.json)<br>[profiles.recall_power_macro·api·fail](evidence/F-DOM-004/2026-09-25-V2-d6668000-profiles.recall_power_macro-api.json) | VAL-02(M), BE-02(C), API-08(M) |
...
| ID | Feature | Target | Level | Recorded | Freshness | Evidence | Open findings |
| --- | --- | --- | --- | --- | --- | --- | --- |
| F-OPS-001 | Run the hub from the Docker image | V4 | V3 | V3 | fresh | [deploy.image_core·api·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_core-api.json)<br>[deploy.image_uc·uc·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_uc-uc.json) | — |
...
| F-OPS-005 | Container health check and auto-restart | V4 | V3 | V3 | fresh | [deploy.image_core·api·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_core-api.json)<br>[deploy.image_uc·uc·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_uc-uc.json) | — |
...
| F-OPS-011 | Enable/disable integrations (UC_ENABLED) | V4 | V3 | V3 | fresh | [deploy.image_core·api·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_core-api.json)<br>[deploy.image_uc·uc·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_uc-uc.json) | DEP-07(M), BE-20(M) |
...
| F-OPS-015 | Hub data persists across restarts (DATA_DIR) | V4 | V3 | V3 | fresh | [deploy.image_core·api·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_core-api.json)<br>[deploy.image_uc·uc·pass](evidence/F-OPS-001/2026-09-26-V3-23239182-deploy.image_uc-uc.json) | DEP-07(M) |
